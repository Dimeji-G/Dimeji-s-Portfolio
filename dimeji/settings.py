...
WSGI_APPLICATION = 'dimeji.wsgi.application'
...
if USE_AZURE_STORAGE:
    ...
    DEFAULT_FILE_STORAGE = 'dimeji.custom_storages.AzureMediaStorage'
    STATICFILES_STORAGE = 'dimeji.custom_storages.AzureStaticStorage'
