"""
Custom Azure Storage classes for handling static and media files separately.

This allows us to use different Azure Blob Storage containers for:
- Static files (CSS, JS, images that are part of the application)
